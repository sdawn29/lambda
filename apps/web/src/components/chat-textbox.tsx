...
> = {
  ...
  mistral: {
    label: "Mistral",
    icon: (
      <svg viewBox="0 0 24 24" className="size-3.5 shrink-0 fill-current text-orange-500" aria-hidden>
  ...
  groq: {
    label: "Groq",
    icon: (
      <svg viewBox="0 0 24 24" className="size-3.5 shrink-0 fill-current text-red-500" aria-hidden>
  ...
  openrouter: {
    label: "OpenRouter",
    icon: (
      <svg viewBox="0 0 24 24" className="size-3.5 shrink-0 fill-current text-violet-500" aria-hidden>
  ...
  "amazon-bedrock": {
    ...
    icon: (
      <svg viewBox="0 0 24 24" className="size-3.5 shrink-0 fill-current text-orange-400" aria-hidden>
  ...
  "azure-openai-responses": {
    label: "Azure OpenAI",
    icon: (
      <svg viewBox="0 0 24 24" className="size-3.5 shrink-0 fill-current text-blue-500" aria-hidden>
  ...
  return (
    PROVIDER_META[providerId] ?? {
      label: providerId
        ...
        .join(" "),
      icon: (
        <span className="flex size-3.5 shrink-0 items-center justify-center rounded-sm bg-muted text-[9px] font-bold uppercase leading-none text-muted-foreground">
          {providerId.charAt(0)}
        </span>
      ),
    }
...
function ModelCombobox({
  ...
  return (
    <div ref={ref} className="relative">
      ...
      {open && (
        <div className="absolute bottom-full left-0 z-50 mb-1 w-60 overflow-hidden rounded-lg bg-popover shadow-md ring-1 ring-foreground/10">
                ...
                <div key={provider}>
                  ...
                  {items.map((m) => (
                    <button
                      ...
                      className={cn(
                        "flex w-full items-center rounded-md px-2 py-1 pl-6 text-left text-xs transition-colors hover:bg-foreground/8",
